  ...
  class StationsController < BaseController
    ...
    def update
      ...
      if situation == "edit address"
        ...
        flash[:notice] = 'This action will delete the address'
      ...
      flash.now[:alert] = 'This action will delete the coordinate pair'
    ...
    def determine_situation(station)
      if station.address != nil && params[:longitude] == "" && params[:latitude] == ""
        ...
        return "delete address, create coordinate_pair"
      elsif station.address == nil && params[:street] == "" && params[:city] == "" && params[:state] == "" && params[:zip] == ""
        return "edit coordinate_pair"
      elsif station.address == nil && params[:street] != "" && params[:city] != "" && params[:state] != "" && params[:zip] != ""
        return "delete coordinate_pair, create address"
      else
